...
| **AIP / Terminal API** | `https://api.aip.unibase.com` | Core Identity, Butler Management, and Invocation |
...
- `AIP_AGENT_ID`: The ID of the Butler agent you are interacting with (e.g., `477` or a handle).
